...
import Heuristic.Heuristica1;
import Heuristic.Heuristica2;
import Heuristic.Heuristica3;
import Heuristic.HeuristicaP;

public class AppMap2 {
    public static void main(String[] args) {
        BestFirst best = new BestFirst("mapInv.txt", 0, 0, 9, 9);
        AStar star = new AStar("mapInv.txt", 0, 0, 9, 9);
